...
The AY-AT GM328 comes with the fuses of the ATmega328P configured in read protected mode, meaning we can not backup the firmware. Trying to read the chip will only result in files filled with the value `FF`. 
